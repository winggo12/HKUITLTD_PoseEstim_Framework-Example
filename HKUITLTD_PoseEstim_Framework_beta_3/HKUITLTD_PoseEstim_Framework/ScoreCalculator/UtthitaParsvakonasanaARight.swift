...
class UtthitaParsvakonasanaARight: YogaBase {
    ...
    private func calculateScore(){
        ...
        score = arm_ratio*left_arm_score + leg_ratio*left_leg_score + leg_angle_ratio*leg_angle_score + arm_leg_dis_ratio*right_elbow_knee_dis_score
        detailedscore = [left_arm_score, left_leg_score, leg_angle_score, right_elbow_knee_dis_score]
    }
