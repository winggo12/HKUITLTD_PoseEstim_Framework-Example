...
class UtthitaTrikonasanaRight: YogaBase {
    ...
    private func calculateScore(){
        ...
        let colorbitmerge: UInt = cb_ll | cb_rl | cb_la | cb_ra | cb_lw | cb_rw | cb_ral

        colorbit = ColorFeedbackUtilities.uint_to_array(colorbitmerge: colorbitmerge)
        score = arm_ratio * arm_score + waist_ratio * waist_score! + leg_ratio * leg_score + arm_leg_dis_ratio  * right_wrist_ankle_dis_score
        detailedscore = [arm_score, waist_score!, leg_score, right_wrist_ankle_dis_score]
    }
