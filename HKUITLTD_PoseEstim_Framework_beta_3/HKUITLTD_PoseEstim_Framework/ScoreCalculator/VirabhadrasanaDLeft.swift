...
class VirabhadrasanaDLeft: YogaBase {
    ...
    private func calculateScore(){
        ...
        arm_score = FeedbackUtilities.right_leg(resultArray!, 180, 20, true)
        ...
        let cb_ra:UInt = ColorFeedbackUtilities.right_arm(score: arm_score)
        let cb_lw:UInt = ColorFeedbackUtilities.left_waist(score: waist_score)
        
        let colorbitmerge: UInt = cb_ll | cb_ra | cb_lw
