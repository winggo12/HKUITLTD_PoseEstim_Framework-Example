...
class MarjarasanaCRight: YogaBase{
    ...
    private func calculateScore(){
        ...
        shoulder_score = FeedbackUtilities.right_shoulder(resultArray!, 90, 110, true)
        ...
        let cb_ra:UInt = ColorFeedbackUtilities.right_arm(score: shoulder_score)
        
        let cb_rw:UInt = ColorFeedbackUtilities.right_waist(score: waist_score)
        
        let colorbitmerge: UInt = cb_rl | cb_ra | cb_rw
