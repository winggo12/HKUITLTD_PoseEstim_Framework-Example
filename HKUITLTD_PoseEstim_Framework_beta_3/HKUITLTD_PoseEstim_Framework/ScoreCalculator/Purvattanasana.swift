...
class Purvattanasana: YogaBase{
    ...
    private func calculateScore(){
        ...
        let colorbitmerge: UInt =  cb_ll | cb_rl | cb_lw | cb_rw | cb_lshl | cb_rshl
        colorbit = ColorFeedbackUtilities.uint_to_array(colorbitmerge: colorbitmerge)
        
        score = leg_ratio * leg_score + waist_ratio * waist_score + shoulder_hand_leg_ratio * shoulder_hand_leg_score
        detailedscore = [waist_score, leg_score, shoulder_hand_leg_score]
