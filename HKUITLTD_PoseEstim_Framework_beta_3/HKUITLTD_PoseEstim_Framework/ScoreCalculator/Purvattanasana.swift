...
class Purvattanasana: YogaBase{
    ...
    private func calculateScore(){
        ...
        left_leg_score = FeedbackUtilities.left_leg(resultArray!, 180.0, 10.0, true)
        right_leg_score = FeedbackUtilities.right_leg(resultArray!, 180.0, 10.0, true)
        ...
        left_shoulder_score = FeedbackUtilities.left_shoulder(resultArray!, 70.0, 10.0, true)
        right_shoulder_score = FeedbackUtilities.right_shoulder(resultArray!, 70.0, 10.0, true)
