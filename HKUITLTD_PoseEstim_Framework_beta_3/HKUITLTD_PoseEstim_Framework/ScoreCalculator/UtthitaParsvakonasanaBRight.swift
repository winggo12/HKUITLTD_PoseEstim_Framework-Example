...
class UtthitaParsvakonasanaBRight: YogaBase {
    ...
    private func calculateScore(){
        ...
        right_shoulder_knee_dis_score = FeedbackUtilities.disToScore(right_shoulder_knee_dis, 0.1 * leg_length, 0.2 * leg_length, true)
        ...
        score = arm_ratio*left_arm_score + leg_ratio*left_leg_score + arm_leg_dis_ratio*right_shoulder_knee_dis_score
        detailedscore = [left_arm_score, left_leg_score,  right_shoulder_knee_dis_score]
    }
