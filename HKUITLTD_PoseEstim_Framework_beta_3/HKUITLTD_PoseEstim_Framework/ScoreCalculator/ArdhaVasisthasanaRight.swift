...
import Foundation
class ArdhaVasisthasanaRight: YogaBase{

    /** constant */
    private var waist_ratio: Double = 0.3
    private var r_hand_shoulder_l_hand_ratio: Double = 0.4
    private var r_shoulder_hand_foot_ratio: Double = 0.4
    ...
    private func calculateScore(){
        ...
        let l_hand_shoulder_r_hand_angle = FeedbackUtilities.getAngle(resultArray![2], resultArray![5], resultArray![6])
        l_hand_shoulder_r_hand_score = FeedbackUtilities.angleToScore(l_hand_shoulder_r_hand_angle, 180, 20, true)
        
        let l_shoulder_hand_foot_angle = FeedbackUtilities.getAngle(resultArray![6], resultArray![2], resultArray![12])
        ...
        score = waist_ratio*waist_score + r_shoulder_hand_foot_ratio*l_shoulder_hand_foot_score + r_hand_shoulder_l_hand_ratio*l_hand_shoulder_r_hand_score
